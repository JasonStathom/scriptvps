...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/JasonStathom/scriptvps/main/ipsec"
...
touch /var/lib/JasonStathom/data-user-l2tp
touch /var/lib/JasonStathom/data-user-pptp
rm -f /root/ipsec.sh
